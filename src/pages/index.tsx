...
const IndexPage: React.FC<PageProps> = () => {
  return (
    <div className="flex justify-center bg-slate-100 text-slate-800 text-xl">
            <div className="w-[1920px]">
      <header className="flex justify-center content-center text-center text-6xl p-20 bg-orange-50 font-playfair"> <h1>{title}</h1></header>
      ...
      <main className="text-2xl">
        <Section style="standard" bgColor="bg-rose-100" heading="We're getting married!" image={<StaticImage src="../images/CCwedding.jpg" className="rounded-lg" alt="Claire and Chris at a wedding" height={400} width={300} quality={100}/>}>
          <p className="font-forum"> On 10th September 2024 we will be getting married in Crete, surrounded by a small number of family members. 
        ...
        <div  className="font-forum"><p> Saturday 28th September</p>
           <p> 12-5pm</p>
           <p> <a href="https://eagleandchildyork.co.uk/contact" target="_blank" className="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline">The Eagle & Child York</a></p>
          <br></br>
          ...
          <p>With the aim of keeping it relaxed we won't be doing any speeches or having a dress code. We also don't expect any gifts. 
            ...
            <br></br> 
            <p>Plenty of car parking is available in York city centre, including the <a href="https://www.york.gov.uk/directory-record/421/monk-bar-car-park-yo31-7qr" target="_blank"  className="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline">Monk Bar</a> and <a href="https://www.york.gov.uk/directory-record/418/marygate-car-park-yo30-7dt" target="_blank" className="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline">Marygate</a> car parks which are just a ten-minute walk from the Eagle & Child.</p>
            </div>
        </Section>
        ...
        <Section style="standard" bgColor="bg-rose-100" heading="RSVP" image={<StaticImage src="../images/CCcornwall.jpg" className="rounded-lg" alt="Claire and Chris in Cornwall"height={300} width={400} quality={100} />}>
          <p className="font-forum"> If you will just be popping in for a drink or cake there's no need to RSVP, but if you would you like to 
            ...
            Please let us know either by <a href="https://forms.gle/xCRbgg3tYdNgRajz9" target="_blank" className="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline">completing our RSVP form</a> or by messaging either one of us by the end of August.</p>
        </Section>
      </main>
    </div></div>
  )
